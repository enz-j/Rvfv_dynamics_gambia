...
# Data
The study is based on sero-epidemiological data from Jarra et al. 2025 (doi:10.1101/2025.03.14.640388). The dataset used to construct the  network is provided as _Ca_move_1__; however, household-level identifiers, including geographic coordinates, have been withheld to preserve confidentiality. Estimated weekly force of infection (FOI) values for each eco-region, used to predict age-seroprevalence curves, are provided in _lambda_vec_.
# Analysis
